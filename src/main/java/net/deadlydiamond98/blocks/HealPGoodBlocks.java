...
public class HealPGoodBlocks {
    ...
    public static final Block HEART_CRYSTAL_BLOCK = register("heart_crystal_block", new Block(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK)));

    public static final BaseStairSlabBlockset POLISHED_HEART_CRYSTAL = new BaseStairSlabBlockset(
            HealingPrettyGood.MOD_ID, "polished_heart_crystal", FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK)
    );
    public static final BaseStairSlabBlockset HEART_CRYSTAL_BRICKS = new BaseStairSlabBlockset(
            HealingPrettyGood.MOD_ID, "heart_crystal_bricks", FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK)
    );
